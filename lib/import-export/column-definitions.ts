...
const studentColumns: ColumnDefinition[] = [
  ...
  },
  {
    ...
    description: 'Student parental status',
    required: false,
    dataType: 'string',
    maxLength: 100,
    example: 'Both Parents',
  },
  {
    csvHeader: 'current_class_name',
    displayName: 'Current Class',
    description: 'Current class name as plain text',
    required: false,
    dataType: 'string',
    maxLength: 100,
    example: 'Primary 4A',
...
export const COLUMN_DEFINITIONS: Record<string, ModuleConfig> = {
  ...moduleConfigs,
