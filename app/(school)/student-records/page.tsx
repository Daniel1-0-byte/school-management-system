...
export default function StudentRecordsPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch('/api/school/academic-years').then((r) => r.json()),
