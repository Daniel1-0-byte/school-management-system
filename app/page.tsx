...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <Link
              href="/login"
              className="px-6 py-2 rounded-lg text-slate-300 hover:text-foreground transition-colors"
            >
              Log In
            </Link>
            <Link
              href="/signup"
              className="px-6 py-2 rounded-lg bg-primary text-primary-foreground font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all"
            >
              Sign Up Your School
            </Link>
          </div>
      ...
      <section className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col justify-center">
        <div className="text-center space-y-8">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 px-8 py-3 rounded-lg bg-primary text-primary-foreground font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all"
            >
              Get Started <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
              href="#features"
              className="inline-flex items-center gap-2 px-8 py-3 rounded-lg border border-border text-slate-300 hover:bg-card transition-colors"
            >
              Learn More
            </Link>
          </div>
      ...
      {/* Features Section */}
      <section id="features" className="bg-muted/40 border-y border-border py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-foreground text-center mb-16">Core Features</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {/* Management */}
            <div className="p-8 rounded-xl bg-card border border-border hover:border-blue-500/50 transition-colors group">
              <div className="w-12 h-12 rounded-lg bg-blue-500/10 flex items-center justify-center mb-4 group-hover:bg-blue-500/20 transition-colors">
                <Users className="w-6 h-6 text-blue-400" />
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-2">School Management</h3>
            ...
            <div className="p-8 rounded-xl bg-card border border-border hover:border-blue-500/50 transition-colors group">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Academic System</h3>
              <p className="text-muted-foreground">
            ...
            <div className="p-8 rounded-xl bg-card border border-border hover:border-blue-500/50 transition-colors group">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Fee Management</h3>
              <p className="text-muted-foreground">
            ...
            {/* Attendance */}
            <div className="p-8 rounded-xl bg-card border border-border hover:border-cyan-500/50 transition-colors group">
            ...
            <div className="p-8 rounded-xl bg-card border border-border hover:border-cyan-500/50 transition-colors group">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Communication Hub</h3>
              <p className="text-muted-foreground">
            ...
            <div className="p-8 rounded-xl bg-card border border-border hover:border-cyan-500/50 transition-colors group">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">SmartClass LMS</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-foreground text-center mb-16">Why Choose SchoolHub?</h2>
      ...
      <footer className="border-t border-border bg-muted/40 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-foreground font-semibold mb-4">SchoolHub</h3>
